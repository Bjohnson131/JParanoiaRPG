...
public class ServerPlayerClearanceMenu extends JMenu {
	...
	public JRadioButtonMenuItem[] securityClearancesByRank = { securityInfraMenuItem, securityRedMenuItem,
			securityOrangeMenuItem, securityYellowMenuItem, securityGreenMenuItem, securityBlueMenuItem,
			securityIndigoMenuItem, securityVioletMenuItem, securityUltraMenuItem };

	//TODO: Dereference the player object.
	public ServerPlayerClearanceMenu(ServerPlayer paramServerPlayer) {
		...
		securityClearancesByRank[this.player.clearanceInt].setSelected(true);
 ...
 * server\ServerPlayerClearanceMenu.class Java compiler version: 2 (46.0)
